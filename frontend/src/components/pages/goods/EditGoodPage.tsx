...
export default function EditGoodPage() {
	...
	const [formData, setFormData] = useState({
		name: mockGood.name,
		description: mockGood.description,
		category: mockGood.category,
		quantity: mockGood.quantity.toString(),
		price: mockGood.price.toString(),
	});
					...
					<form onSubmit={handleSubmit} className="space-y-6">
						...
						{success && (
							<Alert className="border-green-200 bg-green-50">
								<AlertDescription className="text-green-800">
									Good updated successfully! Redirecting to
									details page...
								</AlertDescription>
							</Alert>
						)}
						...
						<div className="flex gap-4">
							<Button
								...
								className="flex-1"
							>
								{loading ? "Updating..." : "Update Good"}
							</Button>
							<Link to={`/goods/${goodId}`} className="flex-1">
								<Button
									type="button"
									variant="outline"
									className="w-full"
